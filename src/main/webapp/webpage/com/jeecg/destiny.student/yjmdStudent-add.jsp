...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="yjmdStudentController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="seqNum" name="seqNum" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="stuName" name="stuName" type="text" maxlength="50" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="signUpTime" name="signUpTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />    
							<span class="Validform_checktip"></span>
