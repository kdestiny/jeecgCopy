...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="yjmdProfileSaleController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="sequenceNum" name="sequenceNum" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="amount" name="amount" type="text" maxlength="20" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="recommendPerson" name="recommendPerson" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="recommendAmount" name="recommendAmount" type="text" maxlength="20" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
